...
public interface GenericErrorMessages {
    ...
    String STATE_CODE_MISMATCH_ERROR = "ERR-ADDR-002";
    String COUNTRY_CODE_MISMATCH_ERROR = "ERR-ADDR-003";
    ...
    String STATE_CODE_MISMATCH =  STATE_CODE_MISMATCH_ERROR + ": The state you provided (%s) does not match the address entered. The expected state for this address is '%s'.";

    String COUNTRY_CODE_MISMATCH =  COUNTRY_CODE_MISMATCH_ERROR + ": The country you provided (%s) does not match the address entered. The expected country for this address is '%s'.";
