...
public class ValidAddressHandler {
    ...
    public Mono<ServerResponse> getValidAddressByAddress(ServerRequest serverRequest) {
        ...
        Mono<AddressDto> addressDto = ContextLogger.observeCtx(logStr, log::info)
        ...
        return ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(addressDto, AddressDto.class);
    }
}
