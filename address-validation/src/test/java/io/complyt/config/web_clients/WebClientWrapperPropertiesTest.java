...
class WebClientWrapperPropertiesTest {
    ...
    void setup() {
        ...
        webClientWrapperProperties = TestUtilities.getWebClientWrapperPropertiesStub();
    }

    @Test
    void Equals_SameWebClientWrapperProperties_ReturnTrue() {
        // Given
        WebClientWrapperProperties givenWebClientWrapperProperties = TestUtilities.getWebClientWrapperPropertiesStub();
