package io.complyt.authentication.repositories.exceptions;
...
class OperationFailedExceptionTest {
    ...
    void constructor_WithThrowableDetails_ExceptionThrown() {
        ...
        // Then
        assertEquals("io.complyt.authentication.repositories.exceptions.OperationFailedException", actualException.getMessage());
    }
}