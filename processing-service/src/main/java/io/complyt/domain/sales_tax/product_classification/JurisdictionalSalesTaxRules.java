...
@Getter
@EqualsAndHashCode
public class JurisdictionalSalesTaxRules implements TaxRules {
    ...
    @JsonCreator
    public JurisdictionalSalesTaxRules(
            ...
            @JsonProperty("cities") Map<String, SubJurisdictionalTaxRules> cities
    ) {
        this.name = name;
