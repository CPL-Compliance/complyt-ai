package com.complyt.config.error_messages;
...
public interface StringErrorMessages {
    ...
    String MINMAX_200_ERROR = "should be 1-200 characters maximum";

    String MINMAX_20_ERROR = "should be 1-20 characters maximum";
