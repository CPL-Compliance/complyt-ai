...
public final class CollectionsNames {
    ...
    public static final String DISTRICT_OF_COLOMBIA = "district_of_columbia";
    ...
    public static final String NEW_HAMPSHIRE = "new_hampshire";
    public static final String NEW_JERSEY = "new_jersey";
    public static final String NEW_MEXICO = "new_mexico";
    public static final String NEW_YORK = "new_york";
    public static final String NORTH_CAROLINA = "north_carolina";
    public static final String NORTH_DAKOTA = "north_dakota";
    ...
    public static final String RHODE_ISLAND = "rhode_island";
    public static final String SOUTH_CAROLINA = "south_carolina";
    public static final String SOUTH_DAKOTA = "south_dakota";
    ...
    public static final String WEST_VIRGINIA = "west_virginia";
