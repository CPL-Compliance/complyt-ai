...
class FastTaxGetBestMatchCityCountyFetcherTest {
    ...
    void fetch_FetchesCityCounty_ReturnsCounty() {
        ...
        FastTaxGetBestMatchData fastTaxGetBestMatchData = new FastTaxGetBestMatchData("0", taxInfoItems, "1", null);
    ...
    @Test
    void fetch_NulltaxItemInfo_ThrowsException() {
        FastTaxGetBestMatchData fastTaxGetBestMatchData = new FastTaxGetBestMatchData("0", null, "1", null);

        // When
        Mono<CityCountyWrapper> cityCountyWrapperMono = fastTaxGetBestMatchCityCountyFetcher.fetch(fastTaxGetBestMatchData);

        // Then
        StepVerifier.create(cityCountyWrapperMono)
                .expectError(UnresolvedAddressException.class) // Expect the exception
                .verify();
    }
