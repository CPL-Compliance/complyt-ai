...
//        return new SalesTaxRates(rate, rate, rate, rate, rate, null, SalesTaxSources.FAST_SALES_TAX);
//    }
//
//    @BeforeEach
//    void setup() {
...
//        // Given + When
//        SalesTaxRates givenSalesTaxRate = SalesTaxRates.zeroSalesTaxRates(SalesTaxSources.SERVICE_OBJECT);
//
//        // Then
