...
public class FastTaxGetBestMatchDataTest {
    ...
    private FastTaxGetBestMatchData createFastTaxGetBestMatchData() {
        ...
        return new FastTaxGetBestMatchData("lvl", taxInfoItemList, "1", null);
    }
    ...
    void Builder_Build_ReturnFastTaxGetBestMatchData() {
        // Given + When
        FastTaxGetBestMatchData actualFastTaxGetBestMatchData = new FastTaxGetBestMatchData("lvl", fastTaxGetBestMatchData.getTaxInfoItems(), "1", null);
