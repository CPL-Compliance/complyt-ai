...
//        // Given
//        RatesMetaData ratesMetaData = new RatesMetaData(new BigDecimal(taxInfoItem.cityDistrictRate()),
//                new BigDecimal(taxInfoItem.cityDistrictRate()));
//        SalesTaxRates expectedSalesTaxRates = SalesTaxRates.zeroSalesTaxRates(SalesTaxSources.SERVICE_OBJECT)
