...
@Slf4j
@Component
public class CityLevelSalesTaxRatesCalculator implements TaxRatesCalculator<SubJurisdictionalTaxRules> {
    /**
     ...
     * @return
     */
    public SalesTaxRates calculate(@NonNull SubJurisdictionalTaxRules citySalesTaxRules, @NonNull SalesTaxRates originalSalesTaxRate) {
