...
@RouterOperations({
        @RouterOperation(
                ...
                @Operation(
                        ...
                        description = "Get all ClientTracing",
                        operationId = "getAllClientTracing",
                        tags = "clientTracing",
                        responses = {
                                @ApiResponse(
                                        responseCode = "200",
                                        ...
                                        content = {
                                                @Content(
                                                        ...
                                                        examples = {
                                                                @ExampleObject(value = GetAllClientTrackingApiInfo.clientTrackingExample)
                                                        })
                                        }),
                                @ApiResponse(
                                        responseCode = "400",
...
public @interface GetAllClientTrackingApiInfo {
    String clientTrackingExample = """
            [{
