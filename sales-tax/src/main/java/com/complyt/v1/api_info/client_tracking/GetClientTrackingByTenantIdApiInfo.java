...
@RouterOperations({
        @RouterOperation(
                ...
                @Operation(
                        ...
                        description = "Get ClientTracing by TenantId",
                        operationId = "getClientTracingByTenantId",
                        parameters = {
...
public @interface GetClientTrackingByTenantIdApiInfo {
    String tenantId = "org_nD6T71fMDbR0qTSY";

    String clientTrackingTenantId = """
            [{
