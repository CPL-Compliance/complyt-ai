...
@RouterOperations({
        @RouterOperation(
                ...
                @Operation(
                        ...
                        description = "Get all Exemptions",
                        operationId = "getAllExemptions",
                        tags = "exemption",
                        responses = {
                                @ApiResponse(
                                        responseCode = "200",
                                        ...
                                        content = {
                                                @Content(
                                                        ...
                                                        examples = {
                                                                @ExampleObject(value = GetAllExemptionsApiInfo.exemptionsExample)
                                                        })
                                        }),
                                @ApiResponse(
                                        responseCode = "400",
...
public @interface GetAllExemptionsApiInfo {

    String exemptionsExample = """
            [{
