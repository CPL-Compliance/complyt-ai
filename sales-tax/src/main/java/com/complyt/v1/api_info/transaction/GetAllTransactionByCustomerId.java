...
@RouterOperations({
        @RouterOperation(
                ...
                @Operation(
                        ...
                        operationId = "getAllTransactionsByCustomer",
                        parameters = {
                                @Parameter(in = ParameterIn.PATH,
                                        name = "customer",
                                        description = "Customer Complyt ID (should be UUID)",
                                        required = true,
                                        examples = @ExampleObject(value = GetAllTransactionByCustomerId.customerIdExample,
                                                name = GetAllTransactionByCustomerId.customerIdExample))
                        },
                        tags = "transaction",
                        responses = {
                                @ApiResponse(
                                        ...
                                        content = {
                                                @Content(
                                                        ...
                                                        examples = {
                                                                @ExampleObject(value = GetAllTransactionByCustomerId.transactionsExample)
                                                        })
                                        }),
                                @ApiResponse(
                                        responseCode = "400",
...
public @interface GetAllTransactionByCustomerId {
    String customerIdExample = "3fa85f64-5717-4562-b3fc-2c963f66afa6\n";
