...
public class ApiExceptionConfig {
    ...
    public Map<Class<? extends Exception>, HttpStatus> exceptionToStatusCode() {
        return Map.ofEntries(
                ...
                Map.entry(CountryNotFoundInJurisdictionalTaxRulesApiException.class, HttpStatus.INTERNAL_SERVER_ERROR),
                Map.entry(CountryNotValidatedApiException.class, HttpStatus.BAD_REQUEST),
                Map.entry(StateNotFoundInJurisdictionalTaxRulesApiException.class, HttpStatus.INTERNAL_SERVER_ERROR),
                Map.entry(StateNotValidatedApiException.class, HttpStatus.BAD_REQUEST),
