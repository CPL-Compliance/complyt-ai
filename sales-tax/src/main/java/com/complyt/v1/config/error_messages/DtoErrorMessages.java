...
public interface DtoErrorMessages {
    ...
    String CUSTOMER_MISSING_ID_OR_EXTERNAL_REFERENCE_AND_SOURCE = "ERR-SALES_TAX-001: Either a customerID OR customerExternalId and customerSource should be provided.";
}