...
public record ShippingFeeDto(boolean manualSalesTax,
                             ...
                             @NotNull(message = "ShippingFee.taxCode " + DtoErrorMessages.NOT_NULL_ERROR) @Size(max = 256, message = "ShippingFee.taxCode " + StringErrorMessages.MINMAX_256_ERROR) String taxCode,
