...
public record TransactionDto(@Schema(description = FieldsDescriptions.COMPLYT_ID + "transaction") UUID complytId,
                             ...
                             @Schema(description = FieldsDescriptions.CUSTOMER_EXTERNAL_REFERENCE) String customerExternalRef,
    ...
    public TransactionDto(UUID complytId, String externalId, String source, String documentName, List<@Valid ItemDto> items, boolean isTaxInclusive, OptionalAddressDto billingAddress, ShippingAddressDto shippingAddress, UUID customerId, CustomerDto customer, SalesTaxDto salesTax, TransactionStatusDto transactionStatus, TimestampsDto internalTimestamps, TimestampsDto externalTimestamps, TransactionTypeDto transactionType, ShippingFeeDto shippingFee, String createdFrom, BigDecimal taxableItemsAmount, BigDecimal tangibleItemsAmount, BigDecimal totalItemsAmount, BigDecimal totalDiscount, BigDecimal transactionLevelDiscount, BigDecimal finalTransactionAmount, TransactionFilingStatusDto transactionFilingStatus, String currency, BigDecimal refRate, ExchangeRateInfoDto exchangeRateInfo, String subsidiary, Boolean isRefundLinked, BigDecimal refundLinkedPercentage) {
        this(complytId, externalId, source, documentName, items, isTaxInclusive, billingAddress, shippingAddress, customerId, customer, salesTax, transactionStatus, internalTimestamps, externalTimestamps, transactionType, shippingFee, createdFrom, taxableItemsAmount, tangibleItemsAmount, totalItemsAmount, totalDiscount, transactionLevelDiscount, finalTransactionAmount, transactionFilingStatus, currency, refRate, exchangeRateInfo, subsidiary, isRefundLinked, refundLinkedPercentage, "", "");
    }
}