...
public class TaxableCollectionBuilderTest {
    ...
    private Transaction createTransaction() {
        ...
        return new Transaction(id, externalId, items, billingAddress, shippingAddress, customerId, customer, null, TransactionStatus.ACTIVE, clientId, null, null, TransactionType.INVOICE, shippingFee);
    }
