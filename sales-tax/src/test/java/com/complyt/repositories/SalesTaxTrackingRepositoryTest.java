...
public class SalesTaxTrackingRepositoryTest extends BaseTestClass {
    ...
    @Mock
    CountryAndStateCriteriaBuilder unitedStatesAddressQueryBuilder; //todo: huh?
    ...
    @Test
    void findByCountryAndState_NullCountryAndState_ThrowsException() {
        // Given
