...
//
//        // When
//        when(salesTaxTrackingRepository.findByCountryStateAndSubsidiary(country, state)).thenReturn(Mono.just(salesTaxTracking));
...
//
//        // When
//        when(salesTaxTrackingRepository.findByCountryStateAndSubsidiary(country, state)).thenReturn(Mono.empty());
