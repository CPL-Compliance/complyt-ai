...
public class SalesTaxTrackingRouterTest implements SalesTaxTrackingRouterTestTemplate {
    ...
    public void getByState_Exists_Returns200WithList() {
        ...
        String subsidiaryId = expectedSalesTaxTrackingDto.subsidiary();
    ...
    public void getByState_ExistsOutsideOfUSA_Returns200WithList() {
        ...
        when(salesTaxTrackingFacade.findByCountryAndState(country, state, subsidiary)).thenReturn(Mono.just(salesTaxTracking.withCountry("Canada")));
    ...
    public void upsertByState_UsaCountry_Returns201() {
        ...
        // When
        when(salesTaxTrackingFacade.findByCountryAndState(country, newSalesTaxTracking.getState().getName(), subsidiaryId)).thenReturn(Mono.empty());
    ...
    public void upsertByState_NonUsaCountry_Returns201() {
        ...
        // When
        when(salesTaxTrackingFacade.findByCountryAndState(country, null, subsidiaryId)).thenReturn(Mono.empty());
        when(salesTaxTrackingFacade.save(newSalesTaxTracking)).thenReturn(Mono.just(receivedSalesTaxTrackingWithId));
    ...
    upsertByState_OutsideOfUsaAndDoesntExists_Returns201() {
        ...
        String subsidiaryId = newSalesTaxTracking.getSubsidiary();
        String state = null;
...
//    @Override
    ...
    public void upsertByState_QueryParamStateIsBlank_Returns200Ok() {
        ...
        String subsidiaryId = givenSalesTaxTrackingDto.subsidiary();
        ...
        webTestClient
                ...
                .value(map -> testUtilities.checkErrorMessages(map,
                        Set.of("state " + DtoErrorMessages.CONFLICTED_WITH_QUERY_PARAM_IN_URL_ERROR,
                                "state " + DtoErrorMessages.STATE_NOT_RECOGNIZED_OR_INVALID_COMBINATION)));
    }
    ...
    public void upsertByState_ExistWithDifferentComplytId_Returns400ConflictedData() {
        ...
        // When
        when(salesTaxTrackingFacade.findByCountryAndState(country, stateName, subsidiaryId)).thenReturn(Mono.just(differentSalesTaxTracking));
    ...
    public void upsertByState_NotRegisteredButDateGiven_Returns400ConflictedData() {
        ...
        // When
        when(salesTaxTrackingFacade.findByCountryAndState("USA", stateName, subsidiaryId)).thenReturn(Mono.just(salesTaxTracking));
        when(salesTaxTrackingFacade.save(salesTaxTracking)).thenReturn(Mono.error(new ConflictedDataApiException()));
    ...
    public void upsertByState_ComplytIdFailedToParse_Returns400() {
        ...
        webTestClient
                ...
                .bodyValue("""
                        ...
                        "appliedDate":  "2023-02-28T02:00:00","approvalDate":  "2023-02-28T02:00:00"}""")
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus().isBadRequest().expectBody(LinkedHashMap.class)
                .value(map -> {
    ...
    public void upsertByStateName_Exists_Returns200() {
        ...
        // When
        when(salesTaxTrackingFacade.findByCountryAndState(country, state, subsidiaryId)).thenReturn(Mono.just(originalSalesTaxTracking));
    ...
    public void refreshByDate_ReturnsSalesTaxTracking_Returns200() {
        ...
        // When
        when(salesTaxTrackingFacade.refreshNexusSummary(country, stateName, localDate, subsidiaryId)).thenReturn(Mono.just(salesTaxTrackingToSend));
    ...
    public void patch_PatchingCountryDifferentThanUsa_Returns200() {
        ...
        String subsidiaryId = salesTaxTrackingOutsideOfUSA.subsidiary();
