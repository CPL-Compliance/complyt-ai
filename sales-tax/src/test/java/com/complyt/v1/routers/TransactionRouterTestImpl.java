...
public class TransactionRouterTestImpl implements TransactionRouterTest {
    ...
    @Override
    @WithMockUser
    public void upsert_NullSalesTaxRatesInSalesTax_Returns400validationError() {
        // Given
        String externalId = transactionDto.externalId();
        String source = transactionDto.source();
        HashSet<String> expectedErrors = new HashSet<>();
        expectedErrors.addAll(List.of(
                "SalesTaxRate may not be null"));
    ...
    @Override
    @WithMockUser
    public void upsert_NullDescriptionInItem_Returns400ValidationError() {
        // Given
        String externalId = transactionDto.externalId();
        String source = transactionDto.source();
        HashSet<String> expectedErrors = new HashSet<>();
    ...
    @Override
    @WithMockUser
    public void upsert_BlankDescriptionInItem_Returns400ValidationError() {
        // Given
        String externalId = transactionDto.externalId();
        String source = transactionDto.source();
        HashSet<String> expectedErrors = new HashSet<>();
    ...
    @Override
    @WithMockUser
    public void upsert_LengthGreaterThen256DescriptionInItem_Returns400ValidationError() {
        // Given
        String externalId = transactionDto.externalId();
        String source = transactionDto.source();
