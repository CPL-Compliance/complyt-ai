...
public class EconomicNexusByPreviousCalenderYearIT extends TestContainersInitializerIT implements EconomicNexusBySpecificCustomersITTemplate {
    ...
    private final ShippingAddressDto referenceAddress = new ShippingAddressDto("Miami", "US", null, "FL", "2100 NW 42nd Ave", "", "33142", false, new MatchedAddressDataDto(new MandatoryAddressDto("Miami", "US", null, "FL", "2100 NW 42nd Ave", "", "33142", false), null));
