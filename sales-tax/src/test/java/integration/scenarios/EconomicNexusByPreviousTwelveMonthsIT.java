...
public class EconomicNexusByPreviousTwelveMonthsIT extends TestContainersInitializerIT implements EconomicNexusByAmountOrCountITTemplate {
    ...
    private final ShippingAddressDto referenceAddress = new ShippingAddressDto("Minneapolis", "US", null, "Minnesota", "4401 York Ave S", "", "55410", false, new MatchedAddressDataDto(new MandatoryAddressDto("Minneapolis", "US", null, "Minnesota", "4401 York Ave S", "", "55410", false), null));
