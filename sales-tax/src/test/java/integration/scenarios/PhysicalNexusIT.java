...
public class PhysicalNexusIT extends TestContainersInitializerIT implements PhysicalNexusITTemplate {
    ...
    private final ShippingAddressDto referenceAddress = new ShippingAddressDto("Atlanta", "US", null, "GA", "50 Upper Alabama St", "", "30303", false, new MatchedAddressDataDto(new MandatoryAddressDto("Atlanta", "US", null, "GA", "50 Upper Alabama St", "", "30303", false), null));
    ...
    public void upsertTransaction_NewAndAfterPhysicalNexus_Returns201WithTaxes() {
        ...
        webTestClient
                ...
                .expectStatus().isCreated()
                .expectBody(TransactionDto.class)
                .value(transactionDto -> assertEquals(new BigDecimal("775"), transactionDto.salesTax().amount()));
    }
