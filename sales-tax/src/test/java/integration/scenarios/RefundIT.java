...
public class RefundIT extends TestContainersInitializerIT implements RefundITTemplate {
    ...
    public void upsertTransaction_NewAfterPhysicalNexus_Returns201WithTaxes() {
        ...
        webTestClient
                ...
                .expectStatus().isCreated()
                .expectBody(TransactionDto.class)
                .value(receivedTransaction -> assertEquals(receivedTransaction.salesTax().amount(), 6200));
    }
        ...
        webTestClient
                ...
                .value(transactionDto ->
                        ...
                        webTestClient
                                ...
                                .expectStatus().isCreated()
                                .expectBody(TransactionDto.class)
                                .value(receivedTransaction -> assertEquals(receivedTransaction.salesTax().amount(), 3100)));
    }
}
