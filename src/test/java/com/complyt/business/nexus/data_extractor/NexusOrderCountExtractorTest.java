...
public class NexusOrderCountExtractorTest {
    ...
    @Test
    void extract_ExtractsOrderItemsCount_ReturnsShouldBeCounted() {
        // Given
    ...
    @Test
    void extract_ExtractsOrderItemsCount_ReturnsShouldNotBeCountedBecauseItemsDontQualify() {
        // Given
        List<Item> items = new ArrayList<Item>() {{
            add(order.getItems().get(0).withTaxableCategory(TaxableCategory.NOT_TAXABLE));
        }};
    ...
    void extract_NullOrderPassed_ThrowsException() {
        ...
        NullPointerException nullPointerException = assertThrows(NullPointerException.class, () -> {
            nexusOrderCountExtractor.extract(nullOrder,nexusStateRule);
        });
    ...
    void extract_NullStateRulePassed_ThrowsException() {
        ...
        // When
        NullPointerException nullPointerException = assertThrows(NullPointerException.class, () -> {
            nexusOrderCountExtractor.extract(order,nullNexusStateRule);
        });
